...
export default function VideoProfilesScreen() {
  ...
  const handleUploadVideo = () => {
    Alert.alert(
      'อัปโหลดวิดีโอ',
      'เลือกวิธีการอัปโหลดวิดีโอของคุณ',
      [
        { text: 'ยกเลิก', style: 'cancel' },
        { text: 'ถ่ายใหม่', onPress: () => console.log('Record new video') },
        { text: 'เลือกจากแกลเลอรี่', onPress: () => console.log('Choose from gallery') }
      ]
    );
  };
  ...
  const renderVideoItem = ({ item }: { item: VideoProfile }) => (
    ...
    >
      <View style={styles.thumbnail}>
        <ThemedText style={styles.thumbnailEmoji}>{item.thumbnailUrl}</ThemedText>
